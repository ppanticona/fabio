...
import { InventarioReportesDialogComponent } from './inventario-reportes-dialog.component';
...
@Component({
  selector: 'jhi-inventario-reportes',
...
export class InventarioReportesComponent implements OnInit {
  ...
  aperturarCaja(caja: ICaja): void {
    const modalRef = this.modalService.open(InventarioReportesDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.caja = caja;
