...
type DetalleOrdenFormDefaults = Pick<NewDetalleOrden, 'id' | 'indDel' | 'fecCrea' | 'fecModif'>;

type DetalleOrdenFormGroupContent = {
  id: FormControl<DetalleOrdenFormRawValue['id'] | NewDetalleOrden['id']>;
  cantidad: FormControl<DetalleOrdenFormRawValue['cantidad']>;
  valUni: FormControl<DetalleOrdenFormRawValue['valUni']>;
  dcto: FormControl<DetalleOrdenFormRawValue['dcto']>;
  subtotal: FormControl<DetalleOrdenFormRawValue['subtotal']>;
...
export class DetalleOrdenFormService {
  createDetalleOrdenFormGroup(detalleOrden: DetalleOrdenFormGroupInput = { id: null }): DetalleOrdenFormGroup {
    ...
    return new FormGroup<DetalleOrdenFormGroupContent>({
      ...
      valUni: new FormControl(detalleOrdenRawValue.valUni, {
        validators: [Validators.required],
      }),
      dcto: new FormControl(detalleOrdenRawValue.dcto, {
        validators: [Validators.required],
      }),
      subtotal: new FormControl(detalleOrdenRawValue.subtotal, {
        validators: [Validators.required],
      }),
