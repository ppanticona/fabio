...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../proveedor.test-samples';

import { ProveedorService, RestProveedor } from './proveedor.service';

const requireRestSample: RestProveedor = {
