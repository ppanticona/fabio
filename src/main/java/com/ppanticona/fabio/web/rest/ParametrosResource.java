...
import com.ppanticona.fabio.repository.ParametrosRepository;
...
/**
 * REST controller for managing {@link com.ppanticona.fabio.domain.Parametros}.
 */
@RestController
@RequestMapping("/api")
public class ParametrosResource {
    ...
    public ResponseEntity<Parametros> updateParametros(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, parametros.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Parametros> partialUpdateParametros(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, parametros.getId())
        );
    }
