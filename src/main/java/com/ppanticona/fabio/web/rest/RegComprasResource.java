...
/**
 * REST controller for managing {@link com.ppanticona.fabio.domain.RegCompras}.
 */
@RestController
@RequestMapping("/api")
public class RegComprasResource {
    ...
    public ResponseEntity<RegCompras> updateRegCompras(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, regCompras.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<RegCompras> partialUpdateRegCompras(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, regCompras.getId())
        );
    }
