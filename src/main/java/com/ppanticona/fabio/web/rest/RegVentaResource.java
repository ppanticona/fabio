...
/**
 * REST controller for managing {@link com.ppanticona.fabio.domain.RegVenta}.
 */
@RestController
@RequestMapping("/api")
public class RegVentaResource {
    ...
    public ResponseEntity<RegVenta> partialUpdateRegVenta(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, regVenta.getId())
        );
    }
