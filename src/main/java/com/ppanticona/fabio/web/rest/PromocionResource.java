...
import com.ppanticona.fabio.repository.PromocionRepository;
...
/**
 * REST controller for managing {@link com.ppanticona.fabio.domain.Promocion}.
 */
@RestController
@RequestMapping("/api")
public class PromocionResource {
    ...
    public ResponseEntity<Promocion> partialUpdatePromocion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, promocion.getId())
        );
    }
