...
/**
 * REST controller for managing {@link com.ppanticona.fabio.domain.DetalleOrden}.
 */
@RestController
@RequestMapping("/api")
public class DetalleOrdenResource {
    ...
    public ResponseEntity<DetalleOrden> partialUpdateDetalleOrden(
        ...
        Optional<DetalleOrden> result = detalleOrdenRepository
            ...
            .map(existingDetalleOrden -> {
                if (detalleOrden.getCantidad() != null) {
                    existingDetalleOrden.setCantidad(detalleOrden.getCantidad());
                }
                if (detalleOrden.getValUni() != null) {
                    existingDetalleOrden.setValUni(detalleOrden.getValUni());
                }
                if (detalleOrden.getDcto() != null) {
                    existingDetalleOrden.setDcto(detalleOrden.getDcto());
                }
                if (detalleOrden.getSubtotal() != null) {
                    existingDetalleOrden.setSubtotal(detalleOrden.getSubtotal());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, detalleOrden.getId())
        );
    }
