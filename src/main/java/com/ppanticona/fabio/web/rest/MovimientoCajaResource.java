...
import com.ppanticona.fabio.repository.MovimientoCajaRepository;
...
/**
 * REST controller for managing {@link com.ppanticona.fabio.domain.MovimientoCaja}.
 */
@RestController
@RequestMapping("/api")
public class MovimientoCajaResource {
    ...
    public ResponseEntity<MovimientoCaja> partialUpdateMovimientoCaja(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, movimientoCaja.getId())
        );
    }
