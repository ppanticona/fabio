...
/**
 * REST controller for managing {@link com.ppanticona.fabio.domain.Caja}.
 */
@RestController
@RequestMapping("/api")
public class CajaResource {
    ...
    public ResponseEntity<Caja> partialUpdateCaja(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, caja.getId()));
    }
