...
/**
 * REST controller for managing {@link com.ppanticona.fabio.domain.Secuencias}.
 */
@RestController
@RequestMapping("/api")
public class SecuenciasResource {
    ...
    public ResponseEntity<Secuencias> updateSecuencias(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, secuencias.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Secuencias> partialUpdateSecuencias(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, secuencias.getId())
        );
    }
