...
import com.ppanticona.fabio.repository.AutorizacionRepository;
...
/**
 * REST controller for managing {@link com.ppanticona.fabio.domain.Autorizacion}.
 */
@RestController
@RequestMapping("/api")
public class AutorizacionResource {
    ...
    public ResponseEntity<Autorizacion> partialUpdateAutorizacion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, autorizacion.getId())
        );
    }
