...
public class MovimientoCaja implements Serializable {
    ...
    public HistoricoCaja getHistoricoCaja() {
        return this.historicoCaja;
    }

    public void setHistoricoCaja(HistoricoCaja historicoCaja) {
        this.historicoCaja = historicoCaja;
    }

    public MovimientoCaja historicoCaja(HistoricoCaja historicoCaja) {
        this.setHistoricoCaja(historicoCaja);
        return this;
    }
